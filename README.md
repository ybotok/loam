...
> **Pre-release: `0.2.0-alpha.6`**, the fifth published release of the 0.2 line and the newest published
...
is seventeen statements of what no check will ever tell you**, printed into the adoption brief beside
...
- [ROADMAP.md](ROADMAP.md) — the evidence-backed improvement plan, priorities, non-goals and exit
  criteria.
- [CHANGELOG.md](CHANGELOG.md) — released beta.1–alpha.6 plus the changes on `main` under
  `[Unreleased]`.
...
`0.2.0-alpha.6`: the unscoped `loam` name is taken by an unrelated GDAL wrapper, so the package ships
