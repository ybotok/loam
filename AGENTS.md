...
It is not the `AGENTS.md` loam writes. That one is generated by `src/core/agent/`, lands in a
*docs repo*, and describes how to use the tool. This one describes how to build it. If you are
editing the `AGENTS_MD` sections in `src/core/agent/agents-md/`, you are editing the other file's
